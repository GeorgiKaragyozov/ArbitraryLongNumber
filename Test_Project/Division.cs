...
namespace Test_Project
{
    ...
    public class Division
    {
        ...
        public void DivisionTest2()
        {
            ...
            ArbitraryLong y = new ArbitraryLong("5");
            Assert.AreEqual(ArbitraryLong.Division(x, y).Value, "105");
        }
        ...
        public void DivisionTest3()
        {
            ...
            Assert.AreEqual(ArbitraryLong.Division(x, y).Value, "111");
        }
        ...
        public void DivisionTest7()
        {
            ...
            Assert.AreEqual(ArbitraryLong.Division(x, y).Value, "463");
        }
